...
function Faker (opts) {
  ...
  var Itcompanies = require('./itcompanies');
  self.itcompanies = new Itcompanies(self);

  var Internet_provider = require('./internetProvider');
  self.internetProvider = new Internet_provider(self);
  ...
  var _definitions = {
    ...
    "title": "",
    "itcompanies": ["companies", "jobDescription", "jobTitle"],
    "separator": "",
    "internetProvider": ["providers", "providerDescription"],
    "separator": ""
